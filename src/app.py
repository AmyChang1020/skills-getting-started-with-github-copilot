...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for practices and games",
    ...
    "Ceramics Workshop": {
        "description": "Create pottery and learn hand-building techniques",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["isabella@mergington.edu", "layla@mergington.edu"]
    },
    "Choir Ensemble": {
        "description": "Sing in a group and perform choral pieces",
    ...
    "Math Olympiad Prep": {
        "description": "Study advanced math problems and prepare for competitions",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
